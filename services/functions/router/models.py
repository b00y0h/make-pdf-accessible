...
class IngestMessage(BaseModel):
    ...
    source_url: Optional[str] = Field(None, description="Source URL for URL-based ingestion")
...
class JobRecord(BaseModel):
    ...
    input_data: Dict[str, Any] = Field(default_factory=dict, description="Input data for the job")
    output_data: Dict[str, Any] = Field(default_factory=dict, description="Output data from the job")
    created_at: datetime = Field(default_factory=datetime.utcnow, description="Creation timestamp")
    updated_at: datetime = Field(default_factory=datetime.utcnow, description="Last update timestamp")
...
class ProcessMessage(BaseModel):
    ...
    step: JobStep = Field(..., description="Processing step")
    priority: bool = Field(False, description="High priority processing")
    input_data: Dict[str, Any] = Field(default_factory=dict, description="Input data for processing")
