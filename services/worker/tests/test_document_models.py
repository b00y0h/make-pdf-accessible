...
from pdf_worker.models.document import (
    DocumentStructure, DocumentElement, Heading, Paragraph, ListElement,
    ListItem, TableElement, TableCell, Figure, BoundingBox,
    ElementType, HeadingLevel, ListType, FigureType
)
