...
class ListElement(DocumentElement):
    ...
    start_number: Optional[int] = Field(None, description="Starting number for ordered lists")
...
class ListItem(DocumentElement):
    ...
    item_number: Optional[int] = Field(None, description="Item number in ordered lists")
...
class TableCell(DocumentElement):
    ...
    scope: Optional[str] = Field(None, description="Header scope (row, col, rowgroup, colgroup)")
...
class TableElement(DocumentElement):
    ...
    summary: Optional[str] = Field(None, description="Table summary for accessibility")
...
class Figure(DocumentElement):
    ...
    long_description: Optional[str] = Field(None, description="Long description for complex figures")
    image_url: Optional[str] = Field(None, description="Image URL or S3 key")
...
class Caption(DocumentElement):
    ...
    caption_for: Optional[str] = Field(None, description="ID of element this caption describes")
