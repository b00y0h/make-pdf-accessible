...
class QuotaService:
    ...
    async def initialize_tenant_quotas(self, org_id: str) -> bool:
        ...
        try:
            ...
            existing_limits = await self.quota_limits_repo.find({
                "org_id": org_id
            })
    ...
    async def get_quota_limits(self, org_id: str) -> Dict[QuotaType, QuotaLimit]:
        ...
        try:
            limits_docs = await self.quota_limits_repo.find({
                "org_id": org_id
            })
    ...
    async def check_quota_limit(self, org_id: str, quota_type: QuotaType, additional_usage: int = 1) -> bool:
    ...
    async def increment_usage(self, org_id: str, quota_type: QuotaType, amount: int = 1) -> bool:
    ...
    async def enforce_quota(self, org_id: str, quota_type: QuotaType, additional_usage: int = 1):
