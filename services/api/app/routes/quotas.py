...
from ..quota import quota_service
...
async def get_quota_status(
    ...
    try:
        ...
        logger.info(
            ...
            extra={"org_id": current_user.org_id, "user_id": current_user.sub},
        )

        return {"org_id": current_user.org_id, "quotas": quota_status}
...
async def initialize_org_quotas(
    ...
    try:
        ...
        logger.info(
            ...
            extra={"org_id": org_id, "admin_user": current_user.sub},
        )
...
async def get_org_quota_status(
    ...
    try:
        ...
        logger.info(
            ...
            extra={"target_org_id": org_id, "admin_user": current_user.sub},
        )

        return {"org_id": org_id, "quotas": quota_status}
