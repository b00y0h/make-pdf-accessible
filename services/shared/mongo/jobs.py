...
class JobRepository(BaseRepository):
    ...
    def create_job(self, job_data: dict) -> dict:
        ...
        try:
            ...
            job_data.setdefault(
                "timeout",
                {"executionTimeoutSeconds": 900, "heartbeatIntervalSeconds": 30},
            )
    ...
    def get_jobs_for_document(
        ...
        try:
            ...
            return self.find(filter_doc=filter_doc, sort=sort, hint=hint)
    ...
    def update_job_status(
        ...
        try:
            ...
            return self.update_by_id(
                doc_id=job_id, update=update_doc, hint={"jobId": 1}
            )
    ...
    def get_stale_jobs(self, timeout_minutes: int = 30) -> list[dict]:
        ...
        try:
            ...
            filter_doc = {"status": "running", "updatedAt": {"$lt": timeout_threshold}}

            return self.find(filter_doc=filter_doc, hint={"status": 1, "updatedAt": -1})
    ...
    def get_job_statistics(self) -> dict:
        ...
        try:
            ...
            result = results[0]
            status_counts = {
                item["status"]: item["count"] for item in result["jobs_by_status"]
            }
            ...
            total_completed = sum(
                ...
                and item["avg_execution_time"] is not None
            )
            avg_execution_time = (
                total_execution_time / total_completed if total_completed > 0 else 0
            )
            ...
            pipeline = [
                ...
                },
                {
                    "$project": {
                        ...
                        "completed": 1,
                        "failed": 1,
                        "success_rate": {"$divide": ["$completed", "$total_jobs"]},
    ...
    def cleanup_old_jobs(self, days: int = 30, status_filter: list[str] = None) -> int:
        ...
        try:
            ...
            filter_doc = {"completedAt": {"$lt": cutoff_date}}
