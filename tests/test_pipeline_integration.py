...
def s3_setup(aws_credentials):
    ...
    with mock_s3():
        ...
        with open('tests/fixtures/sample_document_structure.json', 'r') as f:
...
class TestPipelineIntegration:
    ...
    def test_step_functions_workflow_definition(self):
        ...
        with open('infra/step-functions/pdf-processing-workflow.json', 'r') as f:
    ...
    def test_structure_lambda_input_output_contract(self):
        ...
        from services.functions.structure.models import StructureRequest, StructureResult
    ...
    def test_error_handling_propagation(self):
        ...
        from services.shared.models import ProcessingStatus, ValidationLevel
