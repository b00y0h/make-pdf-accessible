...
export const ALL_INDEXES = {
  documents: [...DOCUMENT_INDEXES, ...ANALYTICS_INDEXES.filter(idx => 
    idx.keys.hasOwnProperty('ownerId') || idx.keys.hasOwnProperty('docId')
  )],
  jobs: [...JOB_INDEXES, ...ANALYTICS_INDEXES.filter(idx => 
 ...
 */
export function getCollectionIndexes(collectionName: 'documents' | 'jobs'): IndexDefinition[] {
