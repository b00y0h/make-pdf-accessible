...
export function useFilterPersistence(
  ...
  const serializeFilters = useCallback((filters: CostFilters): URLSearchParams => {
  ...
  const deserializeFilters = useCallback((searchParams: URLSearchParams): CostFilters => {
  ...
  const updateURL = useCallback((newFilters: CostFilters) => {
