...
export function useS3Upload() {
  ...
  const uploadToS3 = useCallback(async (
    ...
    try {
      ...
      const preSignedResponse = await apiService.apiClient.post('/documents/upload/presigned', {
        filename: file.name,
      ...
      const createResponse = await apiService.apiClient.post('/documents/create', {
