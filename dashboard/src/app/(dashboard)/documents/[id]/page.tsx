            ...
            <div className="grid gap-4">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Comprehensive AI-powered accessibility assessment with
                    confidence scoring
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  ...
                  <div className="grid gap-4 md:grid-cols-2">
                    <div className="p-4 bg-gray-50 rounded-lg">
                      ...
                      <p className="text-xs text-muted-foreground">
                        High confidence - automated improvements applied without
                        human review
                      </p>
                    </div>
                    ...
                    <div className="p-4 bg-green-50 rounded-lg">
                      ...
                      <p className="text-xs text-muted-foreground">
                        ...
                        <br />
                        ✓ Alt-text generated and reviewed
                        <br />
                        ✓ Accessibility tags applied
                        <br />✓ Compliance validation passed
                      </p>
                    </div>
                  </div>
                </CardContent>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    This document is indexed for AI search and can be queried by
                    external LLMs
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  ...
                  <div className="mt-4 p-3 bg-blue-50 rounded-lg">
                    ...
                    <p className="text-xs text-blue-700">
                      Google Gemini, Anthropic Claude, and ChatGPT can search
                      and reference this document via the public embeddings API
                      endpoint.
                    </p>
                  </div>
                </CardContent>
            ...
            <Card>
              <CardContent className="flex flex-col items-center justify-center py-12">
                ...
                <p className="text-muted-foreground text-center">
                  AI accessibility analysis will be available once document
