...
async function getUsersHandler(
  ...
  try {
          ...
          try {
            ...
            */
            ...
            /* eslint-disable */ console.error(
              ...oo_tx(
                `1444215202_189_12_189_76_11`,
                `Error fetching stats for user ${row.id}:`,
                error
              )
            );
    ...
    /* eslint-disable */ console.error(
      ...oo_tx(`1444215202_256_4_256_49_11`, 'Error fetching users:', error)
    );
    return NextResponse.json(
      {
        success: false,
