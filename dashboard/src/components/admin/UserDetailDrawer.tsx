                          ...
                          <div>
                            ...
                            <dd className="mt-1 text-sm text-gray-900 flex items-center space-x-2">
                              <span className="font-mono">
                                {user._id?.toString() || user.sub || user.id}
                              </span>
                              <button
                                onClick={() =>
                        ...
                        {user.documentCount > 0 && (
                          <div className="mt-4">
                            ...
                            <div className="text-xs text-gray-500 mt-1">
                              {Math.round(
                                (user.documentsCompleted / user.documentCount) *
                                  100
                              )}
                              % success rate
                            </div>
                            ...
                            <div className="flex items-center justify-between">
                              <div>
                                ...
                                <p className="mt-1 text-sm text-blue-700">
                                  {user.role === 'admin'
                                    ? 'This user has administrator privileges and can manage other users.'
                                    : 'Grant administrator privileges to allow this user to manage other users.'}
                                </p>
                              </div>
                              <button
                            ...
                            <div className="flex">
                              ...
                              <div className="ml-3">
                                ...
                                <p className="mt-1 text-sm text-red-700">
                                  ...
                                  and all associated documents. This action
                                  cannot be undone.
                                </p>
                                <div className="mt-4">
                                  {!showDeleteConfirm ? (
