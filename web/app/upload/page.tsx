...
import { FileUpload, FileList, FileWithPreview } from '../../components/FileUpload';
...
export default function UploadPage() {
  ...
  const { uploadFiles, uploadProgress, isUploading, resetProgress } = useS3Upload();
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              ...
              <ol className="text-sm text-blue-800 space-y-1 list-decimal list-inside">
                ...
                <li>Your document is automatically processed for accessibility</li>
            ...
            {uploadStatus === 'success' && (
              <div className="rounded-md bg-green-50 p-4" role="alert" aria-live="polite">
                <div className="text-sm text-green-800">
                  ✓ All files uploaded successfully! Redirecting to document details...
                </div>
              </div>
            )}
            ...
            {uploadStatus === 'error' && (
              <div className="rounded-md bg-red-50 p-4" role="alert" aria-live="polite">
                <div className="text-sm text-red-800">
                  ⚠ Some files failed to upload. Please try again or check file requirements.
                </div>
              </div>
            )}
          </div>
